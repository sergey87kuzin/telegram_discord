...
from courses.views import CoursesListView, UserCoursesListView, CourseView, open_next_lesson, LessonView

app_name = "courses"

urlpatterns = [
    path("all_courses/", CoursesListView.as_view(), name="full_list"),
    path("user_courses/", login_required(UserCoursesListView.as_view()), name="user_list"),
