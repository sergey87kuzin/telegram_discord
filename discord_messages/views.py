...
from discord_messages.tasks import handle_telegram_message
...
class GetTelegramMessage(APIView):
    ...
    def post(self, request):
        ...
        handle_telegram_message.apply_async([request.data], queue="messages")
        return Response(HTTPStatus.OK)

    # def handle_message(self, request, translator):
