...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'courses.context_processors.static_root'
            ],
        },
    },
]
...
CELERY_TASK_ROUTES = {
    ...
    "stable_messages.tasks.tasks.send_stable_messages_to_telegram_2": {"queue": "telegram"},
    "stable_messages.tasks.tasks.send_stable_messages_to_telegram_3": {"queue": "telegram"},
    "stable_messages.tasks.tasks.send_stable_messages_to_telegram_4": {"queue": "telegram"},
    ...
    "stable_messages.tasks.tasks.check_not_sent_messages": {"queue": "stable"},
    "stable_messages.tasks.fireworks_api.create_video_from_image": {"queue": "telegram"},
    "stable_messages.tasks.fireworks_api.fetch_video": {"queue": "telegram"},
    "stable_messages.tasks.fireworks_api.clear_space": {"queue": "telegram"},
    "stable_messages.tasks.tasks.send_message_to_stable_new": {"queue": "telegram"},
    "stable_messages.tasks.tasks.resend_messages": {"queue": "stable"},
    "stable_messages.tasks.to_stable.send_first_messages_to_stable_workflow": {"queue": "messages"},
    "stable_messages.tasks.to_stable.send_first_messages_to_stable_1": {"queue": "stable"},
    "stable_messages.tasks.to_stable.send_first_messages_to_stable_2": {"queue": "stable"},
    "stable_messages.tasks.to_stable.send_first_messages_to_stable_3": {"queue": "stable"},
    "stable_messages.tasks.to_stable.send_upscale_vary_messages_to_stable_workflow": {"queue": "stable"},
